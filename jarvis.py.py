...
def wishMe():
    ...
    if hour >= 0 and hour < 12:
        speak("hello, good morning Mrs. Nayana, i wish your day is as pleasant as you are")
        print("hello, good morning Mrs. Nayana ")
    elif hour >= 12 and hour <=18:
        speak("hello, Good afternoon Mrs. Nayana, Sunny days are always bright")
        print("hello, Good afternoon Mrs.Nayana")
    else:
        speak("hello, Good evening Mrs. Nayana, its time to rest and go to sleep soon after you are done with me")
        print("hello, Good evening Mrs. Nayana")
